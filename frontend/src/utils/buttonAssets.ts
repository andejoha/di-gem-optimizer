...
const backgroundImages = import.meta.glob<{ default: string }>(
  '../assets/images/buttons/backgrounds/*.png',
  { eager: true },
);

const iconImages = import.meta.glob<{ default: string }>(
  '../assets/images/buttons/icons/*.png',
  { eager: true },
);

export function getButtonBackgroundUrl(
  variant: ButtonVariant,
  size: TextButtonSize | IconButtonSize,
): string {
